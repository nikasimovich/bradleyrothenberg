...
<html class="no-js">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo bloginfo('template_url'); ?>/css/normalize.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo bloginfo('stylesheet_url'); ?>" />
        <link rel="stylesheet" type="text/css" href="<?php echo bloginfo('template_url'); ?>/css/slick.css" />
        <script src="<?php echo get_bloginfo('template_url'); ?>/js/modernizr-2.6.2.min.js"></script>
        <link rel="stylesheet" media="only screen and (max-width: 1024px)" href="<?php echo bloginfo('template_url'); ?>/css/mobile.css" type="text/css" />
